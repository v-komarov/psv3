...
from	plat.RunSQL	import	LoadPay3
...
def	kass2Base(self,path):
    ...
    ### --- Лог файл ---
    log = 'kass-log/'+fname+'.log'

    ### --- Файл ошибок ---
    err = 'kass-err/'+fname+'.err'
...
### --- Открытие файлов ---	
	...
	### --- Загрузка в базу ---
	result = LoadPay3(db,qarray[0],qarray[1],qarray[2],qarray[3])
	if result != 'OK':
