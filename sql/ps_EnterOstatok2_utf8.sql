CREATE OR REPLACE FUNCTION ps_EnterOstatok2(varchar(24),varchar(30),varchar(10)) RETURNS text
...
--- В отличии от ps_EnterOstatok данная функция вносит остатки даже если движение (платежи или удержания) по услуге уже имели место ---
---
