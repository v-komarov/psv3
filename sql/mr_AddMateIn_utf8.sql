CREATE OR REPLACE FUNCTION mr_AddMateIn(int,varchar(100),numeric(10,2),numeric(10,2)) RETURNS text
...
--- Добавление записи в таблицу поступлений ---
...
WHILE n<>0 LOOP
	genk:=ps_GenKey24();
	SELECT INTO n count(*) FROM mr_mate_in WHERE mr_rec_id=genk;
END LOOP;


--- Добавление записи ---
INSERT INTO mr_mate_in(
mr_rec_id,
mr_mate_kod,
mr_eds_kod,
mr_mate_cost,
